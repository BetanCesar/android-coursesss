package com.example.cesar.mensajespositivos;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdelante = (Button) findViewById(R.id.btnAdelante);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int randomNum =  (int)(Math.random() * (datos.length) + 1);
                currentText = randomNum;
                textView.setText(datos[currentText]);
            }
        });
